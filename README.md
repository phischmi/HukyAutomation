...
As `Action` i chose `VOUT Command` and `Command` is `out(n,{})`, with 'n' = channel '0'. `Factor` is set to '0,04', since the maximum output is 100 * 0,04 = 4,0V
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAxOTEzMDcyNSwtMTk0NTM1NzE0OCwtMj
