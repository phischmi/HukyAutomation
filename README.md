...
As `Action` i chose `VOUT Command` and `Command` is `out(n,{})`, with 'n' = channel '0'. `Factor` is set to '0,04', since the maximum output is 100 * 0,04 = 4,0 Volts. (Rightly it should be 0,042, as the OUT1000 out
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMjI3NjIyNzEsLTE5NDUzNTcxNDgsLT
